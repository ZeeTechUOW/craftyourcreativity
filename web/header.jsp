        ...
        <div class="container" style="margin-top: 10px; position: relative; width: 80%;">
            <div class="navbar-header" style="width: 100%;">
                ...
                <ul class="nav navbar-nav" style="float: left; margin: 0px;">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style='background-color: transparent;'><span class="glyphicon glyphicon-menu-hamburger"></span> Menu 
                ...
                <ul class="nav navbar-nav" style="float: right; margin: 0px;">
                    ...
                    <li class="active" style="display: inline-block; float: left;"><a href="signup">Sign up <span class="sr-only">(current)</span></a></li>
                        ...
                        %>
                    <li class="active" style="display: inline-block; float: left;"><a href="#"><% out.print(loggedUser.getUsername()); %><span class="sr-only">(current)</span></a></li>
                        <%
                            }
                        %>
                </ul>
