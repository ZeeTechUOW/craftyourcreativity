...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!fbRedirectURL.matches("^http:\\/\\/www")) {
            fbRedirectURL = fbRedirectURL.replace("^http:\\/\\/", "http://www.");
        }
        ...
        String twitAuthURL = DirectoryAdmin.getURLContextPath(request) + "/twitterauth";

        request.setAttribute("fbAuthURL", fbAuthURL);
        request.setAttribute("twitAuthURL", twitAuthURL);
